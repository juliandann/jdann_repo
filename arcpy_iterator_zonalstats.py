...
def zonal_stats(shapefiles,raster_path):
    ...
    shapefiles_teller_lidar = [s for s in shapefiles_teller if 'TL_SAR_8' in s]
...
def dbf_to_csv():
    ...
    for dbf_file in arcpy.ListFiles("*Zstats.dbf"):
        outLocation = 'Z:/AKSeward/Data/GIS/Teller/SAR/Lidar_In_situ_SM_analysis/csv_curv_3m_buffer/'
...
def concat_csv(path):
    ...
    print df_final
    df_final.to_csv(path+'all_may_2017_curv_3m_Zstats.csv')
    
#setting working environment
arcpy.env.workspace = 'Z:/AKSeward/Data/GIS/Teller/SAR/Lidar_In_situ_SM_analysis/individual_3m_buffers_v2/'
shapefiles = arcpy.ListFeatureClasses()
raster = 'Z:/AKSeward/DEM/Lidar/2017_UAS/DEMs/JBD_Products/DTM_JBD/Focal_statistics/TL27_0.1m_curv_focal_std_3m.tif'

#zonal_stats(shapefiles,raster)
#dbf_to_csv()
path = 'Z:/AKSeward/Data/GIS/Teller/SAR/Lidar_In_situ_SM_analysis/csv_curv_3m_buffer/'
concat_csv(path)
